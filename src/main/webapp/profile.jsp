...
<body>
	...
	<div class="account-section">
		<div class="side-item">
			...
			<div class="side-menu">
				<ul>
					<li><a href="#profile_page" class="active" autofocus
					...
					<li><a href="/liveon-web/AppointmentHistory" class="active"
							...
							<form id="form" action="updateUser" method="post">
								...
								<div class="number" id="align-num">
									<label class="more"> Number</label> <input class="name"
										...
										placeholder="+91 8923456789"
										value="<%=userDetail.getNumber()%>" required="true">
								</div>
