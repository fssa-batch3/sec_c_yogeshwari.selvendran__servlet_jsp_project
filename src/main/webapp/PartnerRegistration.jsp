...
<body>
	...
	<div class="container">
		...
		<header>
			<p>Partner Registration Form
		</header>
		<form action="partnerRegistration" method="post" class="form">
			<div class="input-box">
				<label>First Name</label> <input type="text"
					name="partner_first_name" placeholder="First name"
					pattern="^[A-Za-z]{2,30}$"
					title="First name should contains only alphabets and atleast of 2 charateers"
					required />
			</div>
			<div class="input-box">
				<label>Last Name</label> <input type="text" name="partner_last_name"
			...
			<div class="input-box">
				<label>Email Address</label> <input type="email"
					name="partner_email" placeholder="Enter email address"
					pattern="^[A-Za-z0-9+_.-]+@(.+)$" required />
			</div>
			<div class="column">
				<div class="input-box">
					<label>Phone Number</label> <input type="tel" name="partner_number"
			...
			<div class="input-box">
				<label>Password</label> <input type="password"
					name="partner_password" placeholder="Enter your password"
		...
		<div class="signin">
			...
			<span>Already have an account?<a href="./PartnerLogin.jsp">Log
					in here</a></span>
