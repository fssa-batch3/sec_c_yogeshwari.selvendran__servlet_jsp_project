...
/**
 * Servlet implementation class AccessoriesDetails
 */
@WebServlet("/AccessoriesDetails")
public class AccessoriesDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/AccessoriesDetails.jsp");
